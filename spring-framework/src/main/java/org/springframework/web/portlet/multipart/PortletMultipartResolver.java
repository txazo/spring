...
public interface PortletMultipartResolver {
	 ...
	 * @throws MultipartException if the portlet request
	 ...
	 * @see ActionRequest#getParameter
	 * @see ActionRequest#getParameterNames
	 * @see ActionRequest#getParameterMap
	 */
