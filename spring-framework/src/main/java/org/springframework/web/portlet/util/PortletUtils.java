...
public abstract class PortletUtils {
	 ...
	 * and throws a {@link FileNotFoundException} if the path cannot
	 * be resolved to a resource (in contrast to
	 * {@link PortletContext#getRealPath PortletContext's {@code getRealPath}},
	 * which simply returns {@code null}).
	 * @param portletContext the portlet context of the web application
	 * @param path the relative path within the web application
	 * @return the corresponding real path
	 * @throws FileNotFoundException if the path cannot be resolved to a resource
	 * @see PortletContext#getRealPath
	 */
	 ...
	 * under the {@link PortletSession#PORTLET_SCOPE}.
	...
	/**
	 * Set the session attribute with the given name to the given value under the {@link PortletSession#PORTLET_SCOPE}.
	...
	/**
	 * Get the specified session attribute under the {@link PortletSession#PORTLET_SCOPE},
	 ...
	 * {@link PortletSession} itself if no mutex attribute found.
	 * <p>The session mutex is guaranteed to be the same object during
	 * the entire lifetime of the session, available under the key defined
	 * by the {@link WebUtils#SESSION_MUTEX_ATTRIBUTE}
	 * constant. It serves as a safe reference to synchronize on for locking
	 * on the current session.
	 * <p>In many cases, the {@link PortletSession} reference
	 ...
	 * @see WebUtils#SUBMIT_IMAGE_SUFFIXES
	 */
	 ...
	 * @see PortletRequest#getParameterNames
	 * @see PortletRequest#getParameterValues
	 * @see PortletRequest#getParameterMap
	 */
	...
	/**
	 * Clear all the render parameters from the {@link ActionResponse}.
