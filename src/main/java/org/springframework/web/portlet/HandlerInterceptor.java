 ...
 * <li>{@link HandlerInterceptor#preHandleAction(ActionRequest, ActionResponse, Object) preHandleAction(..)}
 ...
 * {@link HandlerAdapter#handleAction(ActionRequest, ActionResponse, Object) HandlerAdapter.handleAction(..)}).</li>
 * <li>{@link HandlerInterceptor#afterActionCompletion(ActionRequest, ActionResponse, Object, Exception) afterActionCompletion(..)}
 * is called.</li>
 * </ol>
 *
 ...
 * assembles a handler execution chain consisting of the handler that is to be invoked
 * and all of the {@code HandlerInterceptor} instances that apply to the request.</li>
 * <li>{@link HandlerInterceptor#preHandleRender(RenderRequest, RenderResponse, Object) preHandleRender(..)}
 * is called; if the invocation of this method returns {@code true} then this workflow continues.</li>
 * <li>The target handler handles the render request (via
 * {@link HandlerAdapter#handleRender(RenderRequest, RenderResponse, Object) HandlerAdapter.handleRender(..)}).</li>
 * <li>{@link HandlerInterceptor#postHandleRender(RenderRequest, RenderResponse, Object, ModelAndView) postHandleRender(..)}
 * is called.</li>
 * <li>If the {@code HandlerAdapter} returned a {@code ModelAndView}, then
 * {@code DispatcherPortlet} renders the view accordingly.
 * <li>{@link HandlerInterceptor#afterRenderCompletion(RenderRequest, RenderResponse, Object, Exception) afterRenderCompletion(..)}
 * is called.</li>
 * </ol>
 *
...
public interface HandlerInterceptor {
	 ...
	 * {@link #preHandleAction(ActionRequest, ActionResponse, Object)}
	 ...
	 * <p>Note: Will only be called if this interceptor's
	 * {@link #preHandleRender(RenderRequest, RenderResponse, Object)}
	 * method has successfully completed and returned {@code true}!
	 * @param request current portlet render request
	 * @param response current portlet render response
	 * @param handler chosen handler to execute, for type and/or instance examination
